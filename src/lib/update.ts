...
/**
 * DEMO: gerçek bir yeni sürüm olmasa da akışı uygulamada elle denemek için
 * "güncelleme var" gibi davranır. Gerçek sürüme geçince `false` yapılacak
 * (o zaman kontrol backend'e sorar).
 */
const DEMO_FORCE_UPDATE = true;
